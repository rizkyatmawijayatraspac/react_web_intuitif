...
function TestimonialCoreHR() {
    ...
    return (
        <>
            <div className="intuitif-testimonial-about-area pb-45">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-5">
                            <div className="intuitif-section-title text-center">
                                <h3 className="intuitif-title">What clients say about us</h3>
...
export default TestimonialCoreHR;
