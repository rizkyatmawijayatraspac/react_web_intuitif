...
import serviceThumb from '../../assets/images/hris-personalia.png';

function ServicesCoreHR() {
    return (
        <>
            <section
                ...
                <div className="container">
                  ...
                  "
                                    ...
                                    >
                                        ...
                                        <h4 className="title">Kelola Data Karyawan</h4>
                                        <p>
                                            Kelola seluruh data karyawan mudah dalam satu dashboard
                                        </p>
                                    </div>
                                </div>
