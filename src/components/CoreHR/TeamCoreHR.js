...
function TeamCoreHR() {
    return (
        <>
            <section
                className="
        intuitif-team-area intuitif-team-about-area intuitif-team-8-area
        pt-90
        pb-90
      "
            >
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="intuitif-section-title text-center">
                                <h3 className="intuitif-title">Meet our Team Members</h3>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6">
                            <div
                                className="
                intuitif-team-item intuitif-team-item-about intuitif-team-item-8
                mt-30
                wow
                animated
                fadeInUp
