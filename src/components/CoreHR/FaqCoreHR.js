...
function FaqCoreHR() {
    ...
    return (
        <>
            ...
            <div className="intuitif-faq-8-area pt-100 pb-100" id="counter">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5">
                            <div className="intuitif-section-title">
                                <h3 className="intuitif-title">Request Demo with intuitif Template.</h3>
                                <p>
                                    ...
                                    >
                                        <div className="accrodion-inner">
                                            <div className="accrodion-title">
                                                <h4>Does intuitif have dynamic content?</h4>
                                            </div>
                                            <div
