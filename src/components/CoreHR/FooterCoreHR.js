...
function FooterCoreHR() {
    return (
        <>
            <section className="intuitif-footer-area intuitif-footer-about-area intuitif-footer-8-area">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget-info">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-envelope"></i> support@intuitif.id
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-phone"></i>  +(62) 821 4764 0743
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-map-marker-alt"></i> CBD Metland Transyogi Jl. Metro Ruko Eboni 7 No. 91, Cileungsi Kidul.
                                        </a>
                                    </li>
                                </ul>
                            </div>
