...
function FooterHomeSix() {
    return (
        <>
            <section className="intuitif-footer-area">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-about-widget footer-about-widget-6">
                                ...
                                <p>
                                    intuitif WordPress is theme is the last theme you will ever have.
                                </p>
                                <a href="#">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget-info">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-envelope"></i> support@intuitif.com
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
