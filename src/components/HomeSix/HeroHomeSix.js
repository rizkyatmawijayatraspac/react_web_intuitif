...
function HeroHomeSix() {
    return (
        <>
            <section className="intuitif-hero-area intuitif-hero-6-area">
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6">
                            <div className="intuitif-hero-content intuitif-hero-content-6">
                                <span>Welcome To Creative App.</span>
                                <h1 className="intuitif-title">Request Demo with intuitif Template.</h1>
                                <p>
