...
function FunFactHomeThree() {
    ...
    return (
        <>
            ...
            <section className="intuitif-fun-fact-area" id="fun-fact-area">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div
                                className="intuitif-fun-fact-box wow animated fadeInUp"
                                data-wow-duration="2000ms"
                                data-wow-delay="400ms"
                            >
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="intuitif-fun-fact-content">
                                            <h3 className="title">
                                                Request Demo with intuitif Template.
                                            </h3>
                                            <p>
                                            ...
                                            <div className="row">
                                                <div className="col-sm-4">
                                                    <div className="intuitif-fun-fact-item">
                                                        <h4 className="title">
                                                            <CounterUpCom
                                                                endValue="700"
                                    ...
                                    <div className="col-lg-6">
                                        <div className="intuitif-fun-fact-play">
                                            <a
