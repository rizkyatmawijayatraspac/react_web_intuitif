...
function ShowCaseHomeThree() {
    ...
    return (
        <>
            <section className="intuitif-showcase-area">
                <SimpleReactLightbox>
                    <SRLWrapper>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="intuitif-section-title text-center">
                                        <h3 className="intuitif-title">Creative app showcase</h3>
                                        <p>The app provides design and digital marketing.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row intuitif-showcase-slider">
                                <div className="col-lg-12">
                                    <Slider ref={sliderRef} {...settings}>
                                        <div>
                                            <div className="intuitif-showcase-item mt-30">
                                                <a className="intuitif-image-popup">
