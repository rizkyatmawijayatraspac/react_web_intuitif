...
function SponserHomeTwo({ className }) {
    return (
        <>
            <section className={`intuitif-sponser-area pb-100 ${className}`}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="intuitif-section-title text-center">
                                <h3 className="intuitif-title">
                                    intuitif works best with <br />
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="intuitif-sponser-box d-flex justify-content-center">
                            ...
                            <div className="intuitif-sponser-box item-2 d-flex justify-content-center">
                                <div className="sponser-item">
