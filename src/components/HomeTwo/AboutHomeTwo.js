...
function AboutHomeTwo() {
    return (
        <>
            <section className="intuitif-about-area mb-100">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div
                                className="intuitif-about-box wow animated fadeInUp"
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="intuitif-about-content">
                                            <span>Marketing</span>
                                            <h3 className="title">
                                                Make a lasting impression with intuitif.
                                            </h3>
                                            <p>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="intuitif-about-service mt-30">
                                                    <div className="icon">
