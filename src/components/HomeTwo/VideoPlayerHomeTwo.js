...
function VideoPlayerHomeTwo({ className }) {
    ...
    return (
        <>
            ...
            <section className={`intuitif-video-player-area pb-100 ${className || ''}`}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="intuitif-video-player-item">
                                <div className="thumb">
                                ...
                                <div className="content">
                                    <h3 className="title">
                                        Tonton bagaimana teknologi kami membantu bisnis Anda.
                                    </h3>
                                    <p>
                        ...
                        <div className="col-lg-4">
                            <div
                                className="intuitif-video-player-slider"
